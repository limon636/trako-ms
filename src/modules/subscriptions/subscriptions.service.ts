...
export class SubscriptionsService {
  ...
  async getCurrent(userId: number): Promise<Subscription> {
  ...
  async getHistory(userId: number): Promise<Subscription[]> {
  ...
  async subscribe(userId: number, dto: CreateSubscriptionDto): Promise<Subscription> {
